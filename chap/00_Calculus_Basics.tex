...
\begin{definition}[Fourier Transform]\index{Fourier transform}
  The \emph{Fourier transform} of a function $f(t)$ is defined by
  \[
    \mathcal{F}\{f(t)\}(\omega) = \int_{-\infty}^\infty f(t) e^{-\mathrm{i} \omega t}\,\mathrm{d}t.
  \]
\end{definition}

\begin{definition}[Inverse Fourier Transform]\index{inverse Fourier transform}
  The \emph{inverse Fourier transform} of a function $F(\omega)$ is defined by
  \[
    \mathcal{F}^{-1}\{F(\omega)\}(t) = \frac{1}{2\pi} \int_{-\infty}^\infty F(\omega) e^{\mathrm{i} \omega t}\,\mathrm{d}\omega.
  \]
\end{definition}
