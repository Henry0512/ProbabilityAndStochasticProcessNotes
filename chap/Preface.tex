...
\begin{description}
  \item[Chapter 0] reviews some basic concepts in calculus, which are necessary for understanding the content in the following chapters, and introduces the Fourier transform, which is a powerful tool for analyzing signals and systems in the frequency domain and will be used in power spectral density analysis of stochastic processes.
  ...
  \item[Chapter 6] focuses on stationary stochastic processes, which are a special class of stochastic processes that have statistical properties that do not change over time.
  ...
  \item[Chapter 8] will cover independent increment processes and will be added in the future.
